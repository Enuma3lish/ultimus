...
int main() {
    ...
    std::string output_dir = "./algorithm_result/FCFS_result";
    ...
    std::cout << "========================================\n";
    process_bounded_pareto_random_folders(Fcfs, "FCFS", data_dir, output_dir);

    std::cout << "\n========================================\n";
    std::cout << "Processing Normal random files...\n";
    std::cout << "========================================\n";
    process_normal_random_folders(Fcfs, "FCFS", data_dir, output_dir);

    std::cout << "\n========================================\n";
    std::cout << "Processing Bounded Pareto softrandom files...\n";
    std::cout << "========================================\n";
    process_bounded_pareto_softrandom_folders(Fcfs, "FCFS", data_dir, output_dir);

    std::cout << "\n========================================\n";
    std::cout << "Processing Normal softrandom files...\n";
    std::cout << "========================================\n";
    process_normal_softrandom_folders(Fcfs, "FCFS", data_dir, output_dir);

    std::cout << "\n========================================\n";
    std::cout << "Processing Bounded Pareto combination random files...\n";
    std::cout << "========================================\n";
    process_bounded_pareto_combination_random_folders(Fcfs, "FCFS", data_dir, output_dir);

    std::cout << "\n========================================\n";
    std::cout << "Processing Normal combination random files...\n";
    std::cout << "========================================\n";
    process_normal_combination_random_folders(Fcfs, "FCFS", data_dir, output_dir);

    std::cout << "\n========================================\n";
    std::cout << "Processing Bounded Pareto combination softrandom files...\n";
    std::cout << "========================================\n";
    process_bounded_pareto_combination_softrandom_folders(Fcfs, "FCFS", data_dir, output_dir);
