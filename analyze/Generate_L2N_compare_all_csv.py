...
arithmetic_ls = ['RMLFQ_L2_Norm/SRPT_L2_Norm','RMLFQ_L2_Norm/FCFS_L2_Norm',
                 'RMLFQ_L2_Norm/RR_L2_Norm','RMLFQ_L2_Norm/BAL_L2_Norm']
...
df_melt.to_csv("l2norm_compare_with_needed.csv",index=False)