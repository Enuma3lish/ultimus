...
import Read_csv
import RMLFQ,RR,SJF,SRPT,SETF,FCFS,MLFQ
    ...
    for i in bp_parameter:
        ...
        # Use starmap to run the functions in parallel
            results = pool.starmap(
                process_scheduler,
                    [(RMLFQ.Rmlfq, job_list),(MLFQ.Mlfq,rmlfq_list),(RR.Rr, rr_list), (SRPT.Srpt, srpt_list), (SJF.Sjf, sjf_list),(SETF.Setf,setf_list),(FCFS.Fcfs,fcfs_list)]
                )
            rmlfq,mlfq,rr,srpt,sjf,setf,fcfs = results
