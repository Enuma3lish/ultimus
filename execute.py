...
import Read_csv
import RMLFQ,RR,SJF,SRPT,SETF,FCFS,MLFQ,PRMLFQ,algo_checker,Rmlfq_dy,BAL
...
def execute(Arrival_rate,bp_parameter,base_quantum,quantum_multiplier):
    ...
    for i in bp_parameter:
        ...
        # Use starmap to run the functions in parallel
            ...
            rmlfq_comp_dy = rmlfq_l2n/rmlfq_dy_l2n
            ...
            result.append({
                ...
                "RMLFQ_L2_Norm/RMLFQ_Dy_L2_Norm":rmlfq_comp_dy
