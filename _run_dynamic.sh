...
run_priority_algorithms() {
  ...
  echo "CPU resources will be reallocated dynamically as algorithms complete"
  echo "=========================================="
...
usage() {
  cat <<'EOF'
Pipeline Management Script (Dynamic CPU Allocation)
===================================================
...
Features:
  - Dynamic CPU reallocation as priority algorithms complete
  - Copies random/softrandom results to dedicated location (replaces if exists)
  - Removed analysis folder movement
EOF
}
